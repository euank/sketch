    ...
    // Custom plugin for handling the root path redirect and Monaco workers
    {
      ...
      configureServer(server) {
        ...
        server.middlewares.use((req, res, next) => {
          ...
          // Handle worker URLs
          if (req.url?.startsWith("/static/editor/editor.worker.js")) {
            const workerPath = "/node_modules/monaco-editor/esm/vs/editor/editor.worker.js";
            res.writeHead(302, { Location: workerPath });
            res.end();
            return;
          }
          
          if (req.url?.startsWith("/static/language/json/json.worker.js")) {
            const workerPath = "/node_modules/monaco-editor/esm/vs/language/json/json.worker.js";
            res.writeHead(302, { Location: workerPath });
            res.end();
            return;
          }
          
          if (req.url?.startsWith("/static/language/css/css.worker.js")) {
            const workerPath = "/node_modules/monaco-editor/esm/vs/language/css/css.worker.js";
            res.writeHead(302, { Location: workerPath });
            res.end();
            return;
          }
          
          if (req.url?.startsWith("/static/language/html/html.worker.js")) {
            const workerPath = "/node_modules/monaco-editor/esm/vs/language/html/html.worker.js";
            res.writeHead(302, { Location: workerPath });
            res.end();
            return;
          }
          
          if (req.url?.startsWith("/static/language/typescript/ts.worker.js")) {
            const workerPath = "/node_modules/monaco-editor/esm/vs/language/typescript/ts.worker.js";
            res.writeHead(302, { Location: workerPath });
            res.end();
            return;
          }
          ...
          if (req.url?.startsWith("/static/monaco/min/vs/editor/editor.main.css")) {
          ...
          if (req.url?.startsWith("/static/monaco/min/vs/base/browser/ui/codicons/codicon/codicon.ttf")) {
            const fontPath = "/node_modules/monaco-editor/min/vs/base/browser/ui/codicons/codicon/codicon.ttf";
