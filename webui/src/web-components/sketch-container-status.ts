            ...
            >
              ${this.lastCommit
                ? this.lastCommit.pushedBranch
                  ? (() => {
                      const githubLink = this.getGitHubBranchLink(this.lastCommit.pushedBranch);
                      return html`
                        <div class="commit-info-container">
                          <span 
                            class="commit-branch-indicator main-grid-commit"
                            title="Click to copy: ${this.lastCommit.pushedBranch}"
                          ...
                          ${githubLink
                            ? html`<a
                                ...
                                rel="noopener noreferrer"
                                class="octocat-link"
                                title="Open ${this.lastCommit.pushedBranch} on GitHub"
                                @click=${(e) => e.stopPropagation()}
                              >
                                <svg class="octocat-icon" viewBox="0 0 16 16" width="16" height="16">
