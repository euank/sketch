...
import { GitCommit, GitDataService, GitDiffFile } from '../git-data-service';
  ...
  private mockDiffFiles: GitDiffFile[] = [
    {
      ...
      newHash: 'def0123456789abcdef0123456789abcdef0123'
    },
    {
      ...
      oldMode: '000000',
      oldHash: '0000000000000000000000000000000000000000',
      newHash: 'cde0123456789abcdef0123456789abcdef0123'
    },
    {
      ...
      newMode: '100644',
      oldMode: '100644',
      oldHash: 'abc0123456789abcdef0123456789abcdef0123',
      newHash: 'bcd0123456789abcdef0123456789abcdef0123'
    },
    {
      ...
      newMode: '100644',
      oldMode: '100644',
      oldHash: 'fgh0123456789abcdef0123456789abcdef0123',
      newHash: 'ghi0123456789abcdef0123456789abcdef0123'
    }
  ];
...
button {
  ...
  async getFileContent(commit: string, path: string): Promise<string> {
    console.log(`[MockGitDataService] Getting file content at ${commit}:${path}`);
    
    // Return different content based on file path and commit
    if (path === 'src/components/App.js') {
      return commit.includes('abc123') ? this.appJSModified : this.appJSOriginal;
    } else if (path === 'src/components/FilePicker.js') {
      return this.filePickerJS;
    } else if (path === 'src/components/RangePicker.js') {
      return this.rangePickerJS;
    } else if (path === 'src/styles/main.css') {
      return commit.includes('abc123') ? this.mainCSSModified : this.mainCSSOriginal;
    }
    
    // Return empty string for unknown files
    return '';
  }
